...
import { Mail, Lock, Loader2, HeartPulse, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl shadow-rose-100 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-medical-dark to-rose-600 px-8 py-8 text-white">
            ...
            <h1 className="text-2xl font-extrabold mt-4">Welcome Back</h1>
            <p className="text-white/80 text-sm mt-1">Sign in to book appointments & purchase medicines</p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-500">
                ...
                <Link to="/customer/signup" className="text-medical-primary font-semibold hover:underline">
                  Create account
                </Link>
              </p>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 text-center">
              <p className="text-xs text-gray-400">
                Are you a seller?{' '}
                <Link to="/seller/login" className="text-gray-500 hover:text-medical-primary font-medium">
                  Seller Portal →
                </Link>
              </p>
            </div>
